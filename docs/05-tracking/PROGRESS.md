...
##### 2.6.5 간트차트 드릴다운 (Phase 3)
- [x] 프로젝트 클릭 시 → 프로젝트 상세 페이지로 이동 ✅
- [ ] **팝업 내용 (향후 구현):**
  - [ ] 선택 기간 정보 (프로젝트명, 기간)
  - [ ] 해당 기간 주간 보고 목록 (주차, 주요 추진 실적 요약)
  - [ ] 단계 변경 이력 (ProjectHistory 연동)
  - [ ] 세부추진항목 진행 현황
- [ ] 주간 보고 클릭 → 해당 주차 상세 보기



### Phase 3: 고급 기능 (PRD 3.7~3.13)

#### 3.1 주간 보고서 (PRD 3.13)
- [ ] **주간 보고 API** (/api/weekly-reports)
  - [ ] GET - 주차별 보고 목록 조회
  - [ ] POST - 주간 보고 등록
  - [ ] PUT - 주간 보고 수정 (관리자)
  - [ ] DELETE - 주간 보고 삭제 (관리자)
- [ ] **주간 보고 등록 폼** (팀장)
  - [ ] 주차 선택 (자동 계산: YYYY년 MM월 W주차)
  - [ ] 구분 선택 (농기/중공업/해외/기타)
  - [ ] 고객사/ITEM 연계 드롭다운
  - [ ] 주요 추진 실적 및 계획 (텍스트)
- [ ] **업무일지 기반 초안 자동 생성**
...
#### 3.2 경영진 대시보드 (PRD 3.4)
- [ ] **경영진 메인 대시보드** (/executive)
  - [ ] 즐겨찾기 프로젝트 현황 카드 (최대 6~8개)
  - [ ] 카드 내용: 고객사/ITEM, 현재단계, 진행률, 계획대비 상태
  - [ ] 전체 요약: 정상/지연/완료 프로젝트 수
  - [ ] 금주 주간 보고 요약 (AI 요약 또는 직접 입력)
- [ ] **프로젝트 상세 팝업** (카드 클릭 시)
  - [ ] 기본 정보: 현재단계, 진행률, 상태, 대일정, 팀장
  - [ ] 단계별 진행 시각화 (완료/진행중/예정)
  - [ ] 최근 진행사항 (주간보고 또는 업무일지, 최근 3~5건)
  - [ ] 이슈사항 목록
  - [ ] 경영진 코멘트 + 팀장 답변 (스레드)
- [ ] **계획 vs 실적 비교 페이지** (/executive/comparison)
  - [ ] 즐겨찾기 프로젝트 간트차트 (계획/실적)
  - [ ] 일정 지연 프로젝트 빨간색 하이라이트
  - [ ] 단계별 완료율 시각화
  - [ ] 프로젝트별 코멘트 작성
- [ ] **경영진 코멘트 기능**
...
#### 3.5 고급 검색/필터 (PRD 3.9)
- [ ] **복합 조건 검색**
  - [ ] 날짜 범위 + 프로젝트 + 단계 + 담당자 조합
  - [ ] 고객사, 소속 필터
  - [ ] 진행여부 (진행/보류/완료)
- [ ] **키워드 검색**
  - [ ] 업무진행사항, 이슈사항 내용 검색
...
#### 3.6 엑셀 다운로드 (PRD 3.12)
- [ ] **프로젝트 목록 다운로드**
  - [ ] 현재 필터 적용된 목록
  - [ ] 컬럼: 고객사, ITEM, PART NO, 소속, 팀장, 팀원, 현재단계, 대일정, 상태
  - [ ] 파일명: 프로젝트목록_YYYYMMDD.xlsx
- [ ] **업무일지 목록 다운로드**
  - [ ] 현재 필터 적용된 목록
  - [ ] 컬럼: 날짜, ITEM, 고객사, 단계, 담당자, 계획, 업무내용
  - [ ] 파일명: 업무일지_YYYYMMDD.xlsx
- [ ] **일정 데이터 다운로드**
  - [ ] 전체 간트차트: 모든 프로젝트 대일정
  - [ ] 개별 일정표: 선택 프로젝트 세부추진항목
  - [ ] 컬럼: 프로젝트명, 항목명, 계획시작일, 계획종료일, 실적시작일, 실적종료일, 상태
  - [ ] 파일명: 일정표_YYYYMMDD.xlsx
