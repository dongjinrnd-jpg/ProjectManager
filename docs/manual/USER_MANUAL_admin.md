...
> **⚠️ 경고**: 프로젝트 삭제는 관리자만 가능하며, 삭제 시 관련 데이터도 함께 삭제됩니다.
...
시스템 운영 중 발생한 버그, 개선요청, 기능추가 요청을 등록하고 관리합니다.
