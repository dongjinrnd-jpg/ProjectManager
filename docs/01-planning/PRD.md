...
- [x] **주간 보고서 다운로드:** ✅ (2026-04-27)
  - 미리보기 화면 (/weekly-reports/preview)에서 [📊 엑셀 다운로드] 버튼 (인쇄 버튼 좌측, Excel 녹색 #217346)
  - 다운로드 컬럼: No, 구분, 고객사, ITEM, 주요 추진 실적 및 계획
  - 공지사항 시트 별도 추가 (있을 때만)
...
- [x] **관리자 편집 기능 (집계 화면):**
  ...
  - 수정/삭제 시 확인 다이얼로그 표시
- [x] **주간 보고 다운로드:** ✅
  - [x] **엑셀 다운로드:** 미리보기 화면 인쇄 버튼 좌측 [📊 엑셀 다운로드] 버튼 ✅ (2026-04-27)
    - API: `/api/export/weekly-reports?year=&month=&week=`
    - 파일명: `주간업무보고_YYYY-MM-W주차.xlsx`
    - 시트 1: 보고 항목 (No, 구분, 고객사, ITEM, 주요 추진 실적 및 계획)
    - 시트 2: 공지사항 (있을 때만)
    - Excel 브랜드 녹색(#217346) 버튼
